...
1. Will the following expression return a value or be ⊥? 
   ...
   It will through exception as map will not be able to add 1 to the 1st element as we are taking 1
...
3. Will the following expression return a value?
   ...
   ```
   It will through exception as map will not be able to add 1 to the 2st element as we are taking 2
